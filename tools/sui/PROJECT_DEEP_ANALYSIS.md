...
## Seznam skriptů
- `tools\sui\template\magisk_module\customize.sh` – Extract verify.sh
- `tools\sui\template\magisk_module\post-fs-data.sh` – !/system/bin/sh
- `tools\sui\template\magisk_module\post-install.example.sh` – This script will be loaded during the installation process of Sui.
- `tools\sui\template\magisk_module\riru.sh` – !/sbin/sh
- `tools\sui\template\magisk_module\uninstall.sh` – !/sbin/sh
- `tools\sui\template\magisk_module\util_functions.sh` – Skript util_functions.sh
- `tools\sui\template\magisk_module\verify.sh` – Skript verify.sh
- `tools\sui\gradlew.bat` – Skript gradlew.bat
