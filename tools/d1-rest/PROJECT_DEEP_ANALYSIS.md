# Hluboká analýza: d1-rest

## Základní informace
- **Cílová cesta:** $targetPath
- **Detekované technologie:** Node.js
- **Počet skriptů:** 3
...
## Seznam skriptů
- `tools\d1-rest\src\index.ts` – Skript index.ts
- `tools\d1-rest\src\rest.ts` – **
- `tools\d1-rest\worker-configuration.d.ts` – * eslint-disable */
