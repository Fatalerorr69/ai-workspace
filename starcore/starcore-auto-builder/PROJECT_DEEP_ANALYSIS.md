# Hluboká analýza: starcore-auto-builder-v3-0-live-dashboard
...
## Seznam skriptů
- `starcore\starcore-auto-builder\starcore-auto-builder-deep.sh` – !/bin/bash
- `starcore\starcore-auto-builder\starcore-auto-builder-final.sh` – !/bin/bash
- `starcore\starcore-auto-builder\starcore-auto-builder-lite.sh` – !/bin/bash
- `starcore\starcore-auto-builder\starcore-auto-builder-v3.0.sh` – !/bin/bash
