...
# Projekt: starcore-auto-builder-v3-0-live-dashboard

## Základní informace
- **Cesta v monorepu:** `starcore/starcore-auto-builder`
- **Původní repozitář:** `starcore-auto-builder-v3-0-live-dashboard`
- **Jazyk:** `Shell`
- **Velikost:** `48 KB`
- **Licence:** `None`
