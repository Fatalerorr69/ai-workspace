...
# Projekt: starko-ultimate-recovery-usb

## Základní informace
- **Cesta v monorepu:** `infrastructure/starko-ultimate-recovery-usb`
- **Původní repozitář:** `starko-ultimate-recovery-usb`
- **Jazyk:** `PowerShell`
- **Velikost:** `3232 KB`
- **Licence:** `None`
- **Stav:** `aktivní` (aktivní / udržovaný / neudržovaný / archivovaný)
- **Poslední commit:** `2025-05-12T16:12:28Z`
- **Open issues:** `0`
- **Hvězdy:** `0`, **Forky:** `0`
