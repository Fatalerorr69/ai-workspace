# Hluboká analýza: containers-template

## Základní informace
- **Cílová cesta:** $targetPath
- **Detekované technologie:** Node.js, Docker
- **Počet skriptů:** 2
...
| :--------------- | :------------------------------------ |
| 
> pm run deploy` | Deploy your application to Cloudflare |
...
## Seznam skriptů
- `infrastructure\containers-template\src\index.ts` – Port the container listens on (default: 8080)
- `infrastructure\containers-template\worker-configuration.d.ts` – * eslint-disable */
