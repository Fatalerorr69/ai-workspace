...
Set-Content -Path .\migrate_repo.ps1 -Value $migrate_repo_lines
...
Set-Content -Path .\batch_migrate.ps1 -Value $batch_migrate_lines
...
Set-Content -Path .\run_migration.ps1 -Value $run_migration_lines

# ---------- spustit migraci ----------
Write-Host "Spouštím migraci..." -ForegroundColor Green
