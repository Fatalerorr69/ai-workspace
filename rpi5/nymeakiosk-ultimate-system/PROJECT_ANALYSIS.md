...
## Základní informace
- **Cesta v monorepu:** `rpi5/nymeakiosk-ultimate-system`
- **Původní repozitář:** `nymeakiosk-ultimate-system`
- **Jazyk:** `Shell`
- **Velikost:** `158 KB`
- **Licence:** `MIT`
- **Stav:** `aktivní` (aktivní / udržovaný / neudržovaný / archivovaný)
- **Poslední commit:** `2025-11-11T23:03:52Z`
- **Open issues:** `1`
- **Hvězdy:** `0`, **Forky:** `0`
- **Má GitHub Actions:** `ano`
